...
final class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        notificationCenter.addObserver(self, selector:#selector(AppDelegate.checkForReachability(_:)), name: ReachabilityChangedNotification, object: nil);
        ...
        notificationCenter.addObserverForName(userDidSignOutNotification, object: nil, queue: NSOperationQueue.mainQueue()) { [weak self] notification in
